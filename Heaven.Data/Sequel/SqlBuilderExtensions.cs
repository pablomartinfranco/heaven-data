...
namespace Sequel
{
  public static class SqlBuilderExtensions
  {
    ...
    public static SqlBuilder Having(this SqlBuilder sql, params string[] predicate) =>
      sql.AddClause("having", predicate, "AND ", "HAVING ", null);
    ...
    public static SqlBuilder Join(this SqlBuilder sql, string table, string predicate) =>
      sql.Join(string.Concat(table, string.IsNullOrEmpty(predicate) ? "" : " ON ", predicate));
    ...
    public static SqlBuilder Join(this SqlBuilder sql, string table, string alias, string predicate) =>
      sql.Join(string.Concat(table, " AS ", alias, string.IsNullOrEmpty(predicate) ? "" : " ON ", predicate));
    ...
    /// <returns></returns>
    public static SqlBuilder Value(this SqlBuilder sql, params string[] values) =>
      sql.AddClause("values", values, ", ", "VALUES (", ")");
    ...
    /// <param name="predicates"></param>
    /// <returns></returns>
    public static SqlBuilder Script(this SqlBuilder sql, params string[] predicates)
    {
      sql.SetTemplate("script");
      return sql.AddClause("script", string.Join(" ", predicates), string.Empty, string.Empty, null);
    }
  }
}
